...
private String testCaseResult;
	...
	@SheetColumn(value = "DebitSettlementMode")
	private String debitsettlemtnmode;
	...
	public String getDebitsettlemtnmode() {
		return debitsettlemtnmode;
	}

	public void setDebitsettlemtnmodetab(String debitsettlemtnmodetab) {
		this.debitsettlemtnmode = debitsettlemtnmode;
	}
	...
	public String toString() {
		return "CLDACCNT_Page [testCaseResult=" + testCaseResult + ", testCaseId=" + testCaseId + ", runMode=" + runMode
				...
				+ ", paymentmodetab=" + paymentmodetab + ", creditsettlemtnmode=" + creditsettlemtnmode
				+ ", creditpaymentmodetab=" + creditpaymentmode + ", creditaccountbranch=" + creditaccountbranch
				+ ", creditproductAccount=" + creditproductAccount + ", debitsettlemtnmodetab=" + debitsettlemtnmode
