...
import com.jmr.testsuite.fas.page.wb.CashDeposit_1401Page;
...
public class CashDeposit_1401Test extends AbstractTestNGSpringContextTests{
	...
	private final String screenName = "Cash Deposit : Branch Date 01-03-2019";
	...
	public void executeTestCase() throws Exception {
		...
		for (CashDeposit_1401Page data : dataList1) {
			...
			if (data.getRunMode().equalsIgnoreCase("Yes") || data.getRunMode().equalsIgnoreCase("Y")) {
				...
				fcubs.populateTextById("BLK_TRANSACTION_DETAILS__XRATEI", data.getExchangerate());
