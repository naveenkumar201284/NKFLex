...
import com.jmr.testsuite.fas.page.st.STSCUSAC_Page;

import io.github.millij.poi.ss.reader.XlsxReader;

@ContextConfiguration(classes = SpringConfiguration.class)

public class STSCUSAC_Test extends AbstractTestNGSpringContextTests{
	...
	private final String screenId = "STSCUSAC";
	private final String screenName="Customer Accounts Summary";

	private List<STSCUSAC_Page> dataList;
	private List<STSCUSAC_Page> resultList;
...
//		dataList1 = xlsReader.read(CFDFLTRI.class, new File(AppConfig.testFileLocation), 13);
		dataList = fcubs.loadDataFromExcel(STSCUSAC_Page.class, screenId);
	...
	@Test()
		...
		public void executeTestCase() throws Exception {
			...
			for (STSCUSAC_Page data : dataList) {
				try {
	...
	public void tearDown(ITestResult result) {
		...
		for (STSCUSAC_Page data : resultList) {
