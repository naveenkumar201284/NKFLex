...
import com.jmr.testsuite.fas.TransactionManager;
...
public class DepositAccountBooking extends AbstractTestNGSpringContextTests {
	...
	public void init() throws Exception {
		...
		dataList = fcubs.loadDataFromExcel(DepositAccountBookingPage.class, screenId);
	...
	public void executeTestCase() throws Exception {
		for (DepositAccountBookingPage data : dataList) {
			try {
				...
				//to update status as WIP in progress
				//txMan.updateTestProgCaseExecStatAsWIP(data.getTestCaseId());
