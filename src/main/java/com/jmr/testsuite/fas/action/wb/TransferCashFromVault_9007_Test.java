...
import com.jmr.testsuite.fas.page.wb.TransferCashFromVault_9007_Page;

import io.github.millij.poi.ss.reader.XlsxReader;

@ContextConfiguration(classes = SpringConfiguration.class)
public class TransferCashFromVault_9007_Test  extends AbstractTestNGSpringContextTests{
	...
	private final String screenId = "9007";
	private final String screenName="Transfer Cash from Vault : Branch Date 2019-03-01";

	private List<TransferCashFromVault_9007_Page> dataList1;
	private List<TransferCashFromVault_9007_Page> resultList1;
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = fcubs.loadDataFromExcel(TransferCashFromVault_9007_Page.class, screenId);
	...
	public void executeTestCase() throws Exception {
		...
		for (TransferCashFromVault_9007_Page data : dataList1) {
			try {
		...
		public void tearDown(ITestResult result) {
			...
			for(TransferCashFromVault_9007_Page data:resultList1) {
