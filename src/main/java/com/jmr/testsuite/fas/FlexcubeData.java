...
import com.jmr.testsuite.fas.page.common.LoginPageActionObdx;
...
//import com.jmr.testsuite.fcdb.CommonUtils;

import io.github.millij.poi.ss.reader.XlsxReader;

	@Component
	public class FlexcubeData {
	...
	//	private WebDriverWait driverWait;
		 ...
		 * @throws Exception
		 */
		public void launchScreen(String tabName) throws Exception {
			/*driver.switchTo().defaultContent();
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(tabName)).click();		
		}
					...
					for (String key : recordMap.keySet()) {
						...
						while (itElementId.hasNext() && itElementValue.hasNext() && itElementType.hasNext()) {
							...
							case "radio":
								...
								break;
							case "select":
								selectDropdownByTextid(elementId, elementValue);
								break;
							case "dropdown":
								selectDropdownByTextXpath(elementId, elementValue);
								break;
							case "lov":
								if (validInput(elementValue) && elementValue.contains(":")) {
									clickButtonByXpath(
		 ...
		 * 
		 */
		public void selectDropdownByTextid(String elementId, String text) throws UIFormatException, Exception {
			if (validInput(text)) {
				element = driver.findElement(By.id(elementId));
				focusToElement(element);
		...
		public void selectDropdownByTextXpath(String elementName, String text) throws UIFormatException, Exception {
			if (validInput(text)) {
	...
	public void setScreenDetails(String screenId, String screenName) {
		...
		public void ClickButton(String elementxpath, String text) throws UIFormatException {
			if (checkElementNValue(elementxpath, text)) {
		...
		public void ClickClass(String elementxpath, String text) throws UIFormatException {
			if (checkElementNValue(elementxpath, text)) {
				element = driver.findElement(By.className(elementxpath));
				focusToElement(element);
				if (validInput(element.getAttribute("class"))) {
					element.click();
		...
		public void openMenu(String actionName) {
